...
#define DELAY_SYS_RUN_LED_ON        DELAY_MS(960)
#define DELAY_SYS_RUN_LED_OFF       DELAY_MS(40)
#define DELAY_SYS_FAULT_LED_ON      DELAY_MS(40)
#define DELAY_SYS_FAULT_LED_OFF     DELAY_MS(960)
